...
build-docker:
	docker build -t tbtec/tremligeiro-customer:1.0.0 .

run-docker:
	docker run -p 8080:8080 tbtec/tremligeiro-customer:1.0.0 --env-file .env
...
docker-push:
	docker push tbtec/tremligeiro-customer:1.0.0
